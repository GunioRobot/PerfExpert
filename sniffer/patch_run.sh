...
then
	echo -e "The file ${parent_dir}/perfexpert_run_exp could not be patched. Please patch it manually by replacing the line \"${replaceHook}\" in ${parent_dir}/perfexpert_run_exp.default with the following contents and saving it as ${parent_dir}/perfexpert_run_exp:\n"
