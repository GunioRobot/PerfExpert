...
enum { TOT_INS=0, TOT_CYC, LD_INS, L1_DCA, L2_DCA, L2_TCA, L1_ICA, L2_ICA, L2_DCM, L2_ICM, L2_TCM, TLB_DM, TLB_IM, BR_INS, BR_MSP, FP_INS, FML_INS, FDV_INS, FAD_INS, L1I_CYCLES_STALLED, ARITH_CYCLES_DIV_BUSY, FP_COMP_OPS_EXE_SSE_SINGLE_PRECISION, FP_COMP_OPS_EXE_X87, FP_COMP_OPS_EXE_SSE_DOUBLE_PRECISION, FP_COMP_OPS_EXE_SSE_FP, FP_COMP_OPS_EXE_SSE_FP_PACKED, FP_COMP_OPS_EXE_SSE_FP_SCALAR, FP_COMP_OPS_EXE_SSE_DOUBLE_PRECISION_SSE_FP_SSE_FP_PACKED_SSE_FP_SCALAR_SSE_SINGLE_PRECISION_X87, RETIRED_SSE_OPERATIONS_ALL, SSEX_UOPS_RETIRED_PACKED_DOUBLE, SSEX_UOPS_RETIRED_PACKED_SINGLE, SSEX_UOPS_RETIRED_SCALAR_DOUBLE, SSEX_UOPS_RETIRED_SCALAR_SINGLE, SSEX_UOPS_RETIRED_SCALAR_DOUBLE_SCALAR_SINGLE, SIMD_COMP_INST_RETIRED_PACKED_DOUBLE, SIMD_COMP_INST_RETIRED_PACKED_SINGLE, SIMD_COMP_INST_RETIRED_SCALAR_DOUBLE, SIMD_COMP_INST_RETIRED_SCALAR_SINGLE, SIMD_COMP_INST_RETIRED_SCALAR_SINGLE_SCALAR_DOUBLE, ENUM_LENGTH };
...
char* counter_names [ENUM_LENGTH] = { "PAPI_TOT_INS", "PAPI_TOT_CYC", "PAPI_LD_INS", "PAPI_L1_DCA", "PAPI_L2_DCA", "PAPI_L2_TCA", "PAPI_L1_ICA", "PAPI_L2_ICA", "PAPI_L2_DCM", "PAPI_L2_ICM", "PAPI_L2_TCM", "PAPI_TLB_DM", "PAPI_TLB_IM", "PAPI_BR_INS", "PAPI_BR_MSP", "PAPI_FP_INS", "PAPI_FML_INS", "PAPI_FDV_INS", "PAPI_FAD_INS", "L1I_CYCLES_STALLED", "ARITH:CYCLES_DIV_BUSY", "FP_COMP_OPS_EXE:SSE_SINGLE_PRECISION", "FP_COMP_OPS_EXE:X87", "FP_COMP_OPS_EXE:SSE_DOUBLE_PRECISION", "FP_COMP_OPS_EXE:SSE_FP", "FP_COMP_OPS_EXE:SSE_FP_PACKED", "FP_COMP_OPS_EXE:SSE_FP_SCALAR", "FP_COMP_OPS_EXE:SSE_DOUBLE_PRECISION:SSE_FP:SSE_FP_PACKED:SSE_FP_SCALAR:SSE_SINGLE_PRECISION:X87", "RETIRED_SSE_OPERATIONS:ALL", "SSEX_UOPS_RETIRED:PACKED_DOUBLE", "SSEX_UOPS_RETIRED:PACKED_SINGLE", "SSEX_UOPS_RETIRED:SCALAR_DOUBLE", "SSEX_UOPS_RETIRED:SCALAR_SINGLE", "SSEX_UOPS_RETIRED:SCALAR_DOUBLE:SCALAR_SINGLE", "SIMD_COMP_INST_RETIRED:PACKED_DOUBLE", "SIMD_COMP_INST_RETIRED:PACKED_SINGLE", "SIMD_COMP_INST_RETIRED:SCALAR_DOUBLE", "SIMD_COMP_INST_RETIRED:SCALAR_SINGLE", "SIMD_COMP_INST_RETIRED:SCALAR_SINGLE:SCALAR_DOUBLE" };

int counter_freq [ENUM_LENGTH] = { 13000027, 13000049, 5300083, 5300003, 1300021, 1300031, 5300027, 1300051, 1300073, 1300111, 1300843, 510007, 510031, 2300017, 510047, 5300081, 5300033, 510049, 5300063, 510067, 510079, 3000017, 3000029, 3000047, 3000061, 3000073, 3000077, 510127, 5300033, 510101, 510047, 510079, 510089, 510079, 510101, 510047, 510079, 510089, 510079 };
...
int main(int argc, char* argv [])
{
	...
	else if (IS_COUNTER_AVAILABLE(LD_INS))
	{
		USE_COUNTER(LD_INS);
		strcpy(ratio_data_accesses, "ratio.data_accesses = PAPI_LD_INS / PAPI_TOT_INS\n\n");
	}
	...
	if (IS_COUNTER_AVAILABLE(RETIRED_SSE_OPERATIONS_ALL))
	{
		USE_COUNTER(RETIRED_SSE_OPERATIONS_ALL);

		strcpy(gflops_overall, "percent.GFLOPS_(%_max).overall = (RETIRED_SSE_OPERATIONS:ALL / PAPI_TOT_CYC) / 4\n");
		strcpy(gflops_packed,  "");
		strcpy(gflops_scalar,  "\n");
	}
	else if (IS_COUNTER_AVAILABLE(SSEX_UOPS_RETIRED_PACKED_DOUBLE) && IS_COUNTER_AVAILABLE(SSEX_UOPS_RETIRED_PACKED_SINGLE) && IS_COUNTER_AVAILABLE(SSEX_UOPS_RETIRED_SCALAR_DOUBLE) && IS_COUNTER_AVAILABLE(SSEX_UOPS_RETIRED_SCALAR_SINGLE))
	{
		// Do a dummy test to see if the single big counter can be added or do we have to break it down into multiple parts
		if (testCounter(SSEX_UOPS_RETIRED_SCALAR_DOUBLE_SCALAR_SINGLE) == 0)
		{
			USE_COUNTER(SSEX_UOPS_RETIRED_PACKED_DOUBLE);
			USE_COUNTER(SSEX_UOPS_RETIRED_PACKED_SINGLE);

			USE_COUNTER(SSEX_UOPS_RETIRED_SCALAR_DOUBLE_SCALAR_SINGLE);
			DELETE_COUNTER(SSEX_UOPS_RETIRED_SCALAR_DOUBLE);
			DELETE_COUNTER(SSEX_UOPS_RETIRED_SCALAR_SINGLE);

			strcpy(gflops_overall, "percent.GFLOPS_(%_max).overall = ((SSEX_UOPS_RETIRED:PACKED_DOUBLE*4 + SSEX_UOPS_RETIRED:PACKED_SINGLE*2 + SSEX_UOPS_RETIRED:SCALAR_DOUBLE:SCALAR_SINGLE) / PAPI_TOT_CYC) / 4\n");
			strcpy(gflops_packed,  "percent.GFLOPS_(%_max).packed = ((SSEX_UOPS_RETIRED:PACKED_DOUBLE*4 + SSEX_UOPS_RETIRED:PACKED_SINGLE*2) / PAPI_TOT_CYC) / 4\n");
			strcpy(gflops_scalar,  "percent.GFLOPS_(%_max).scalar = ((SSEX_UOPS_RETIRED:SCALAR_DOUBLE:SCALAR_SINGLE) / PAPI_TOT_CYC) / 4\n\n");
		}
		else
		{
			...
			USE_COUNTER(SSEX_UOPS_RETIRED_SCALAR_DOUBLE);
			USE_COUNTER(SSEX_UOPS_RETIRED_SCALAR_SINGLE);

			strcpy(gflops_overall, "percent.GFLOPS_(%_max).overall = ((SSEX_UOPS_RETIRED:PACKED_DOUBLE*4 + SSEX_UOPS_RETIRED:PACKED_SINGLE*2 + SSEX_UOPS_RETIRED:SCALAR_SINGLE + SSEX_UOPS_RETIRED:SCALAR_DOUBLE) / PAPI_TOT_CYC) / 4\n");
			strcpy(gflops_packed,  "percent.GFLOPS_(%_max).packed = ((SSEX_UOPS_RETIRED:PACKED_DOUBLE*4 + SSEX_UOPS_RETIRED:PACKED_SINGLE*2) / PAPI_TOT_CYC) / 4\n");
			strcpy(gflops_scalar,  "percent.GFLOPS_(%_max).scalar = ((SSEX_UOPS_RETIRED:SCALAR_SINGLE + SSEX_UOPS_RETIRED:SCALAR_DOUBLE) / PAPI_TOT_CYC) / 4\n\n");
		}
	}
	else if (IS_COUNTER_AVAILABLE(SIMD_COMP_INST_RETIRED_PACKED_DOUBLE) && IS_COUNTER_AVAILABLE(SIMD_COMP_INST_RETIRED_PACKED_SINGLE) && IS_COUNTER_AVAILABLE(SIMD_COMP_INST_RETIRED_SCALAR_DOUBLE) && IS_COUNTER_AVAILABLE(SIMD_COMP_INST_RETIRED_SCALAR_SINGLE))
	{
		// Do a dummy test to see if the single big counter can be added or do we have to break it down into multiple parts
		if (testCounter(SIMD_COMP_INST_RETIRED_SCALAR_SINGLE_SCALAR_DOUBLE) == 0)
		{
			USE_COUNTER(SIMD_COMP_INST_RETIRED_PACKED_DOUBLE);
			USE_COUNTER(SIMD_COMP_INST_RETIRED_PACKED_SINGLE);

			DELETE_COUNTER(SIMD_COMP_INST_RETIRED_SCALAR_DOUBLE);
			DELETE_COUNTER(SIMD_COMP_INST_RETIRED_SCALAR_SINGLE);
			USE_COUNTER(SIMD_COMP_INST_RETIRED_SCALAR_SINGLE_SCALAR_DOUBLE);

			strcpy(gflops_overall, "percent.GFLOPS_(%_max).overall = ((SIMD_COMP_INST_RETIRED:PACKED_DOUBLE*4 + SIMD_COMP_INST_RETIRED:PACKED_SINGLE*2 + SIMD_COMP_INST_RETIRED:SCALAR_SINGLE:SCALAR_DOUBLE) / PAPI_TOT_CYC) / 4\n");
			strcpy(gflops_packed,  "percent.GFLOPS_(%_max).packed = ((SIMD_COMP_INST_RETIRED:PACKED_DOUBLE*4 + SIMD_COMP_INST_RETIRED:PACKED_SINGLE*2) / PAPI_TOT_CYC) / 4\n");
			strcpy(gflops_scalar,  "percent.GFLOPS_(%_max).scalar = ((SIMD_COMP_INST_RETIRED:SCALAR_SINGLE:SCALAR_DOUBLE) / PAPI_TOT_CYC) / 4\n\n");
		}
		else
		{
			USE_COUNTER(SIMD_COMP_INST_RETIRED_PACKED_DOUBLE);
			...
			USE_COUNTER(SIMD_COMP_INST_RETIRED_SCALAR_DOUBLE);
			USE_COUNTER(SIMD_COMP_INST_RETIRED_SCALAR_SINGLE);

			strcpy(gflops_overall, "percent.GFLOPS_(%_max).overall = ((SIMD_COMP_INST_RETIRED:PACKED_DOUBLE*4 + SIMD_COMP_INST_RETIRED:PACKED_SINGLE*2 + SIMD_COMP_INST_RETIRED:SCALAR_SINGLE + SIMD_COMP_INST_RETIRED:SCALAR_DOUBLE) / PAPI_TOT_CYC) / 4\n");
			strcpy(gflops_packed,  "percent.GFLOPS_(%_max).packed = ((SIMD_COMP_INST_RETIRED:PACKED_DOUBLE*4 + SIMD_COMP_INST_RETIRED:PACKED_SINGLE*2) / PAPI_TOT_CYC) / 4\n");
			strcpy(gflops_scalar,  "percent.GFLOPS_(%_max).scalar = ((SIMD_COMP_INST_RETIRED:SCALAR_SINGLE + SIMD_COMP_INST_RETIRED:SCALAR_DOUBLE) / PAPI_TOT_CYC) / 4\n\n");
		}
	}
	else	counter_err("GFLOPS");
	...
	{
		USE_COUNTER(LD_INS);
		sprintf(data_accesses_overall, "data_accesses.overall = (PAPI_LD_INS * L1_dlat + %s * L2_lat + %s * mem_lat) / PAPI_TOT_INS\n", lcpi_L2_DCA, lcpi_L2_DCM);
		strcpy(data_accesses_L1d_hits, "data_accesses.L1d_hits = (PAPI_LD_INS * L1_dlat) / PAPI_TOT_INS\n");
	}
	else	counter_err("data_accesses_L1d_hits");
	...
	{
		// Do a dummy test to see if the single big counter can be added or do we have to break it down into multiple parts
		if (testCounter(FP_COMP_OPS_EXE_SSE_DOUBLE_PRECISION_SSE_FP_SSE_FP_PACKED_SSE_FP_SCALAR_SSE_SINGLE_PRECISION_X87) == 0)
		{
...
int testCounter(unsigned ctr)
{
	...
	int event_code;
	PAPI_event_name_to_code(counter_names[ctr], &event_code);
	if (PAPI_add_event(event_set, event_code) == PAPI_OK)
	{
